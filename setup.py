...
class build_ext(setuptools.command.build_ext.build_ext):
    ...
    def _embed_libiomp(self):
        ...
        libtorch_path = os.path.join(libdir, 'libtorch.dylib')
        libtorch_python_path = os.path.join(libdir, 'libtorch_python.dylib')
        ...
        for rpath in rpaths:
            for lib in [torch_cpu_path, torch_path, torch_python_path]:
